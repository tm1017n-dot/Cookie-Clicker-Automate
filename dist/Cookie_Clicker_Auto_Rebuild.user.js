...
const { createPlanner }=require("src/runtime/planner-client.mjs");
...
class Coordinator {
  constructor(page,adapter,{config={},diagnostics=new Diagnostics(),clock=()=>Date.now(),onUpdate=()=>{},planner=plan}={}){
    ...
    this.clock=clock;this.onUpdate=onUpdate;this.planner=planner;this.version='9.0.0-alpha.15';this.generation=0;
...
"src/runtime/planner-client.mjs":function(require,exports){
const { plan }=require("src/core/planner.mjs");

function createPlanner(page,source){
...
Object.assign(exports,{createPlanner});
}
};const cache={};function require(id){if(!cache[id]){cache[id]={};factories[id](require,cache[id]);}return cache[id];}require("src/runtime/browser.mjs");delete globalThis.__CC_AUTO_PLANNER_WORKER_SOURCE__;})();
