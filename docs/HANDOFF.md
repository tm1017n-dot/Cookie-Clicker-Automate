...
alpha.14（2026-09-25）：長期Tier・Kitten等の直接経路に加え、将来購入する対象施設の倍率、Synergy、施設・Upgrade価格割引を先に買う経路を比較。1目標6候補・全体24経路へ制限し、無関係な高収益Upgradeへ不要な目標予約を付けない。自動試験149件。詳細は[長期目標途中の強化Upgrade](rebuild/GOAL_INVESTMENTS_ALPHA14.md)。ブラウザ検証なし。
