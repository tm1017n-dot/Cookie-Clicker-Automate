...
再構築版 **9.0.0-alpha.13**: [導入・検証結果・対応範囲](docs/rebuild/IMPLEMENTATION.md) / [配布userscript](dist/Cookie_Clicker_Auto_Rebuild.user.js)。購入・待機・クリック・相乗効果・自然GC予測・長期解禁経路・診断再生を実装した段階です。ミニゲーム等を含む全機能の完成版ではありません。
