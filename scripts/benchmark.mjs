...
for(const [engine,planner,input] of [['alpha6',alpha6Plan,{...stress,engineVersion:'9.0.0-alpha.6',rulesetVersion:'cc-web-2.058/strategy-1'}],['current',plan,stress]]){
...
for(const [engine,planner,input] of [['alpha6',alpha6Plan,{...gcStress,engineVersion:'9.0.0-alpha.6'}],['current',plan,gcStress]]){
for(let n=0;n<5;n++)planner(input);
